    ...
    <Layout>
      ...
      <div className="card flex flex-col h-[calc(100vh-180px)]">
        ...
        <div className="flex-none p-4 border-b border-gray-100/60">
          <div className="flex justify-between items-center gap-3 mx-auto mb-3">
            <h2 className="w-100 text-sm font-semibold text-gray-700">
              Zlecenia
            </h2>
            ...
            <div className="w-110 flex items-center gap-2">
              ...
              <div className="relative flex-1">
                ...
                <input
                  ...
                  placeholder="Szukaj po opisie, kliencie, wykonawcy..."
              ...
              >
                ...
                Filtry
                {hasActiveFilters && (
                  <span className="w-2 h-2 rounded-full bg-sky-500 ml-0.5" />
                )}
              </button>
            </div>
          ...
          {/* Expandable filters */}
          <div
            className={`${filterOpen ? 'max-h-40 opacity-100' : 'max-h-0 opacity-0 overflow-hidden'} transition-all duration-300`}
          >
            <div className="flex flex-wrap gap-3 justify-center pt-2 pb-1">
              ...
              <div className="w-56">
                <CustomSelect
                  ...
                  onChange={(val) =>
                    setFilters((p) => ({ ...p, executor: val }))
                  }
                  options={[
                    { value: '', label: 'Wszyscy wykonawcy' },
                    ...employees.map((e) => ({
                      value: e._id,
